...
<template>
  ...
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-6 pb-4  bg-white dark:bg-gray-800 text-black dark:text-white">
        <div class="flex h-16 shrink-0 items-center">
          <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=white" alt="Your Company" />
        </div>
        <nav class="flex flex-1 flex-col">
    ...
    <div class="lg:pl-72">
      <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8  bg-white dark:bg-gray-800 text-black dark:text-white">
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6  bg-white dark:bg-gray-800 text-black dark:text-white">
          <form class="relative flex flex-1" action="#" method="GET">
            <label for="search-field" class="sr-only">Search</label>
            <MagnifyingGlassIcon class="pointer-events-none absolute inset-y-0 left-0 h-full w-5 text-gray-400  bg-white dark:bg-gray-800 text-black dark:text-white" aria-hidden="true" />
            <input id="search-field" class="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm  bg-white dark:bg-gray-800 text-black dark:text-white" placeholder="Search..." type="search" name="search" />
          </form>
      ...
      <main class="h-screen bg-white dark:bg-gray-800 text-black dark:text-white">
